...
public class ItemsSalesProductionTest {
	private final String ROOT_URL = "http://localhost:8080/REST_API/itemsSales";
	...
	public final void testGetAll() {
		try {
			...
			String temp;
			String res = "";
			System.out.println("Request Sales - getAll: Status: "
	...
	public void testGetAllParams() {
		try {
			...
			String temp;
			String res = "";
			System.out.println("Request Sales - getAllParams: Status: "
					+ response.getStatus() + "; Output ->");
			while ((temp = br.readLine()) != null) {
				res += temp;
			}
	...
	public final void testGetById() {
		try {
			...
			System.out.println("Request Sales - getById: Status: " + status
					+ "; Output ->");
			while ((temp = br.readLine()) != null) {
				res += temp;
			}
	...
	@Test
	public final void testCreateRowSales() {
		try {
			ClientRequest request = new ClientRequest(ROOT_URL);
